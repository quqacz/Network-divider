...
exports.getDivisionBlock = exports.getDivisions = exports.validateMask = void 0;
const masks = [
...
function validateMask(checkedMask) {
...
function validateHostsCount(checkedMask, count) {
    for (let i = 0; i < masks.length; i++) {
...
function getDivisionBlock(mask) {
    const blocks = mask.split('.');
    for (let i = 0; i < blocks.length; i++) {
        if (blocks[i] !== '255') {
            return i;
...
exports.getDivisionBlock = getDivisionBlock;
